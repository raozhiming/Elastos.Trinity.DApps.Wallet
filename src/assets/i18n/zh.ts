export const zh = {
    ...
    'text-pay-password-input': '请输入支付密码',
    'text-password-compare': '两次输入内容不一样',
    'text-keystroe-message': '将此文本复制到一个安全的地方（记事本）',
    'text-copy-to-clipboard': '复制到剪贴板',
    'text-copied-to-clipboard': '已复制到剪贴板',
    'text-backup-password-input': '请输入私钥文件密码',
    'text-phrase-password-input': '请输入助记词密码',
    ...
    'Error-20003': '密码错误',
    'Error-20004': '无效ID',
    'Error-20005': 'SPV创建主钱包错误',
    'Error-20006': 'SPV创建子钱包错误',
