export const en = {
    ...
    'transfer-address': 'Target Address',
    'send-raw-transaction': 'Transaction sent',
    ...
    'text-pay-password-input': 'Please input pay password',
    'text-password-compare': 'Inconformity password',
    ...
    'text-backup-password-input': 'Input SecretKey Password',
    'text-phrase-password-input': 'Input Mnemonics Password',
    ...
    'Error-20005': 'SPV create master wallet error',
    'Error-20006': 'SPV create sub wallet error',
    ...
    'sync-completed': 'Initial wallet synchronization finished! You can now send payments securely.',
