...
export class ScanPage implements OnInit {
  ...
  pageType:string;
  constructor( private navCtrl: NavController, public route: ActivatedRoute, private qrScanner: QRScanner, private modalCtrl: ModalController
        ...
        this.qrScanner.scan().subscribe((text: string) =>
           {
             switch(this.pageType){
               ...
               case "3":
                 ...
                 this.native.Go(this.navCtrl,"/txdetails",senddata);
                   break;
               case "4":
                this.hideCamera();
                this.navCtrl.pop();
                let senddata1 = {"content":text,type:3};
                this.native.Go(this.navCtrl,"/txdetails",senddata1);
                   break;
               case "5":
