...
export class WalletManagerPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, public route: ActivatedRoute, public events: Events,
  ...
  onItem(i) {
    switch (i){
      case 0:
        this.native.Go(this.navCtrl, "/exprot-prikey");
        break;
      case 1:
       this.native.Go(this.navCtrl, "/paypassword-reset");
        break;
      case 2:
      ...
      case 3:
        this.native.Go(this.navCtrl, "/publickey");
         break;
      case 4:
         this.native.Go(this.navCtrl, "/modifywalletname");
         break;
      case 5:
         this.native.Go(this.navCtrl, "/exportmnemomic");
         break;
    }
  }
